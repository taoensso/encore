...
#?(:clj
   (defmacro binding
     ...
     {:added "Encore v3.96.0 (2024-03-19)"
      :style/indent 1}
     [bindings & body]
     (if (:ns &env)
...
#?(:clj
   (defmacro ^:private with-default-print-limits
     [form]
     (if (:ns &env)
       `(binding [*print-level* nil, *print-length* nil] ~form)
...
#?(:cljs
   (do
     (def* pr      "Identical to `core/pr`."      {:added "Encore v3.96.0 (2024-03-19)"} cljs.core/pr)
     (def* prn     "Identical to `core/prn`."     {:added "Encore v3.96.0 (2024-03-19)"} cljs.core/prn)
     (def* print   "Identical to `core/print`."   {:added "Encore v3.96.0 (2024-03-19)"} cljs.core/print)
     (def* println "Identical to `core/println`." {:added "Encore v3.96.0 (2024-03-19)"} cljs.core/println))
...
(deprecated
  ...
  (def* ^:no-doc println-atomic "Prefer `println`."       {:deprecated "Encore v3.96.0 (2024-03-19)"} println)

  #?(:cljs (def* ^:no-doc ajax-lite "Prefer `ajax-call`." {:deprecated "Encore v3.74.0 (2023-11-06)"} ajax-call))
  #?(:cljs (def* ^:no-doc now-dt    "Prefer `now-inst`."  {:deprecated "Encore v3.96.0 (2024-03-19)"} now-inst))
  #?(:clj
     (do
  ...
  #?(:clj
     (defmacro ^:no-doc deftype-print-methods "Prefer `def-print`."
       {:deprecated "Encore v3.96.0 (2024-03-19)"}
       [& types]
       `(do
          ~@(map
              (fn [type]
